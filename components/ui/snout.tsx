...
export function Snout({ className = "", size }: SnoutProps) {
  return (
    <svg
      className={className}
      width={size}
      height={size}
      viewBox="0 0 605.59 566.52"
    ...
    >
      ...
      <g>
        <path 
          className="cls-1" 
          d="M288.21,50.54c-63.18,3.42-121.46,29.01-164.15,75.62C-.22,261.87,35.09,459.03,225.29,500.5c156.71,34.16,347.11-37.49,326.74-225.84-14.3-132.27-130.71-231.33-263.82-224.11Z"
        />
        <g>
